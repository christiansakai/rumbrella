defmodule InfoSysTest do
  ...
  test "compute/2 with timeout returns no results and kills workers" do
    results = InfoSys.compute("timeout", 
      backends: [TestBackend], timeout: 19)
  ...
  # This tag is so that the error message
  # does not get reported to the console since
  # this error is intentionally made for testing
  @tag :capture_log
